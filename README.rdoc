...
Seed the database.  <b>Note:</b> Seeding the DB takes a couple of hours
on a decent 64-bit processor.
...
I want to review web servers (options with Rack) and deployment options
(Tomcat via war file, e.g.).
...
to be parsed separately.  In particular, there is a simple online
