...
Dubsar is a dictionary web application using Ruby on Rails.
The content is taken from the Princeton University
WordNet[http://wordnet.princeton.edu] project.

Dubsar is deployed at https://dubsar.info.

For more information, see the
{Dubsar wiki on GitHub}[https://github.com/jdee/dubsar/wiki].

On the Dubsar site:
{About Dubsar}[https://dubsar.info/about]
-- {FAQ}[https://dubsar.info/faq]
-- {QUnit test suite}[https://dubsar.info/qunit]
-- {Tour}[https://dubsar.info/tour]
...
- {Dubsar on Google Play}[https://play.google.com/store/apps/details?id=com.dubsar_dictionary.Dubsar]
