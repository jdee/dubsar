...
- There is not much error handling in the controller.  If the user
  submits a badly-formed request (by manually editing the URL), she
  can get an unpleasant error message.  But navigating normally
  through the application does not produce such problems.
...
It might be interesting to write a Dubsar AJAX plug-in, using the
WordNet data set, for looking up definitions and synonyms of key words
in the text of any web page.
